 ...
 <!-- <div class='sidenav'>
   ...
   <div class="w3-sidebar w3-bar-block w3-light-grey" style="width:25%">
     ...
     <a href="liveSearch.php" class="w3-bar-item w3-button">Employee Payment Status</a><br>
       <a href="seeTeacherAccount.php" class="w3-bar-item w3-button">Teacher Accounts</a><br>
         <a href="seeStudentAccount.php" class="w3-bar-item w3-button">Student Accounts</a><br>
...
<div class="w3-container w3-dark-white" style="margin-top:50px">
  <form class="loginbox" onclick="return validation()" method="post" action="../controller/payroll.php">


    <p>Teacher Name::</p> <input type="text" onkeypress="checkName()" onblur="checkName()" name="name" id="name" placeholder="Enter Name">
    <br><br>
    <span class="error" id="nameErr">* <?php if(!empty($_GET['nameErr'])){echo $_GET['nameErr'];} ?></span>
    <br>
     <p>Teacher ID:</p> <input type="text" onkeypress="checkCode()" onblur="checkCode()" name="code" id="code" placeholder="Enter id">
    <br><br>
    <span class="error" id="codeErr">* <?php if(!empty($_GET['codeErr'])){echo $_GET['codeErr'];} ?></span>
    <br>
    <p>Payment amount:</p> <input type="text" onkeypress="checkSection()" onblur="checkSection()" name="section" id="section" placeholder="Enter payment amount">
    <br><br>
    <span class="error" id="sectionErr">* <?php if(!empty($_GET['sectionErr'])){echo $_GET['sectionErr'];} ?></span>
    <br>
    <p>Payment Date:</p> <input type="text"  onkeydown="checkTime()" onblur="checkTime()" name="time" id="time" placeholder="Enter time" >
    <br><br>
