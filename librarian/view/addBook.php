...
<html lang="en" dir="ltr">
 ...
 <!-- <div class='sidenav'>
   ...
   <div class="w3-sidebar w3-bar-block w3-light-grey" style="width:25%">
     ...
     <a href="borrowedBook.php" class="w3-bar-item w3-button">Borrowed Books by Students</a><br>
...
<div class="w3-container w3-dark-white" style="margin-top:50px">
  <form class="loginbox" onclick="return validation()" method="post" action="../controller/addBook.php">
    ...
    <br>
    <p>Available Piece:</p> <input type="text" onkeypress="checkSection()" onblur="checkSection()" name="section" id="section" placeholder="Enter piece">
    <br><br>
